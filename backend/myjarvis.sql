...
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_001', 'C', '2025년 1분기 웹사이트 유지보수 계약', '가나다 솔루션의 웹사이트 안정성 확보를 위한 분기별 유지보수 계약입니다.', TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-03-31', 'YYYY-MM-DD'), 3000000, TO_DATE('2024-12-15', 'YYYY-MM-DD'));
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0001', 'COMP0001', 'MEM_001', '당사자');

-- 계약 데이터 2
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_001', 'W', '스마트 코딩 아카데미 신규 LMS 개발', '수강생 관리 및 온라인 강의를 위한 신규 학습 관리 시스템(LMS) 개발 계약서입니다.', TO_DATE('2025-02-10', 'YYYY-MM-DD'), TO_DATE('2025-08-31', 'YYYY-MM-DD'), 25000000, NULL);
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0002', 'COMP0002', 'MEM_001', '당사자');

-- 계약 데이터 3
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_002', 'W', '디자인 마스터즈 로고 및 브랜딩 리뉴얼', '기업 이미지 제고를 위한 CI/BI 리뉴얼 디자인 계약입니다.', TO_DATE('2025-03-01', 'YYYY-MM-DD'), TO_DATE('2025-04-30', 'YYYY-MM-DD'), 8000000, NULL);
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0003', 'COMP0003', 'MEM_002', '당사자');

-- 계약 데이터 4
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_003', 'C', '든든 로지스틱스 물류 시스템 컨설팅', '물류창고 관리 시스템(WMS) 도입을 위한 프로세스 컨설팅 계약서.', TO_DATE('2024-11-01', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 12000000, TO_DATE('2024-10-20', 'YYYY-MM-DD'));
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0004', 'COMP0004', 'MEM_003', '당사자');

-- 계약 데이터 5
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_001', 'X', '글로벌 무역 상사 ERP 구축 제안', '전사적 자원 관리(ERP) 시스템 구축 제안이었으나 고객사 사정으로 취소됨.', TO_DATE('2025-01-15', 'YYYY-MM-DD'), TO_DATE('2025-07-31', 'YYYY-MM-DD'), 50000000, NULL);
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0005', 'COMP0005', 'MEM_001', '당사자');

-- 계약 데이터 6
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_002', 'C', '2024년 연간 마케팅 대행 계약', 'SNS 및 블로그 콘텐츠 마케팅 연간 대행.', TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 24000000, TO_DATE('2023-12-20', 'YYYY-MM-DD'));
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0006', 'COMP0003', 'MEM_002', '당사자');

-- 계약 데이터 7
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_001', 'W', '모바일 앱(iOS/AOS) 개발 계약', '신규 서비스 런칭을 위한 하이브리드 앱 개발.', TO_DATE('2025-04-01', 'YYYY-MM-DD'), TO_DATE('2025-10-31', 'YYYY-MM-DD'), 45000000, NULL);
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0007', 'COMP0001', 'MEM_001', '당사자');

-- 계약 데이터 8
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_003', 'T', '서버 인프라 이전 및 클라우드 컨설팅', '기존 IDC에서 AWS로 이전하기 위한 컨설팅 (임시저장).', TO_DATE('2025-05-01', 'YYYY-MM-DD'), TO_DATE('2025-06-30', 'YYYY-MM-DD'), 7500000, NULL);
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0008', 'COMP0004', 'MEM_003', '당사자');

-- 계약 데이터 9
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_001', 'C', '2024년 법률 자문 계약', '연간 법률 자문 서비스 제공.', TO_DATE('2024-02-01', 'YYYY-MM-DD'), TO_DATE('2025-01-31', 'YYYY-MM-DD'), 10000000, TO_DATE('2024-01-25', 'YYYY-MM-DD'));
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0009', 'COMP0002', 'MEM_001', '당사자');

-- 계약 데이터 10
INSERT INTO TBL_CONTRACT (CONTRACT_NO, MEMBER_NO, STATUS_CODE, CONTRACT_TITLE, CONTRACT_CONTENT, CONTRACT_START, CONTRACT_END, CONTRACT_DEPOSIT, CONTRACT_CONFIRM) 
VALUES ('CNO_'||LPAD(SEQ_TBL_CONTRACT_NO.NEXTVAL, 4, '0'), 'MEM_002', 'W', '쇼핑몰 상세페이지 디자인 개선', '구매전환율 상승을 위한 상세페이지 UI/UX 개선 작업.', TO_DATE('2025-03-15', 'YYYY-MM-DD'), TO_DATE('2025-04-15', 'YYYY-MM-DD'), 4000000, NULL);
INSERT INTO TBL_CONTRACT_PARTY (ID, CONTRACT_NO, COMP_CD, MEMBER_NO, ROLE) 
VALUES (SEQ_CONTRACT_PARTY_ID.NEXTVAL, 'CNO_0010', 'COMP0003', 'MEM_002', '당사자');
