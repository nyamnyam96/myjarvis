...
VALUES ('INV_'||LPAD(SEQ_TBL_INVOICE_NO.NEXTVAL, 4, '0'), 'CNO_0001', 'MEM_001', 18000000, TO_DATE('2024-04-05', 'YYYY-MM-DD'), 'Y', TO_DATE('2024-04-15', 'YYYY-MM-DD'), 'Y', '계좌이체', TO_DATE('2024-04-01', 'YYYY-MM-DD'), 'C');

-- 2. (진행) '유튜브 채널 운영 대행' 계약에 대한 7월분 청구
INSERT INTO TBL_INVOICE (INVOICE_NO, CONTRACT_NO, MEMBER_NO, INVOICE_DEPOSIT, INVOICE_SEND, INVOICE_IS_SEND, INVOICE_PAID, INVOICE_IS_PAID, INVOICE_METHOD, REG_DATE, INVOICE_STATUS_CODE)
VALUES ('INV_'||LPAD(SEQ_TBL_INVOICE_NO.NEXTVAL, 4, '0'), 'CNO_0005', 'MEM_001', 5000000, TO_DATE('2025-07-05', 'YYYY-MM-DD'), 'Y', NULL, 'N', '카드결제', TO_DATE('2025-07-01', 'YYYY-MM-DD'), 'U');

-- 3. (취소) '글로벌 마켓 리서치' 계약에 대한 청구 (계약이 취소되었으므로 청구도 취소 상태 가정)
INSERT INTO TBL_INVOICE (INVOICE_NO, CONTRACT_NO, MEMBER_NO, INVOICE_DEPOSIT, INVOICE_SEND, INVOICE_IS_SEND, INVOICE_PAID, INVOICE_IS_PAID, INVOICE_METHOD, REG_DATE, INVOICE_STATUS_CODE)
VALUES ('INV_'||LPAD(SEQ_TBL_INVOICE_NO.NEXTVAL, 4, '0'), 'CNO_0009', 'MEM_002', 15000000, TO_DATE('2025-08-01', 'YYYY-MM-DD'), 'N', NULL, 'N', '가상계좌', TO_DATE('2025-07-25', 'YYYY-MM-DD'), 'P');

-- 4. (완료) '제품 카탈로그 디자인' 계약에 대한 청구
INSERT INTO TBL_INVOICE (INVOICE_NO, CONTRACT_NO, MEMBER_NO, INVOICE_DEPOSIT, INVOICE_SEND, INVOICE_IS_SEND, INVOICE_PAID, INVOICE_IS_PAID, INVOICE_METHOD, REG_DATE, INVOICE_STATUS_CODE)
VALUES ('INV_'||LPAD(SEQ_TBL_INVOICE_NO.NEXTVAL, 4, '0'), 'CNO_0008', 'MEM_001', 5500000, TO_DATE('2024-07-25', 'YYYY-MM-DD'), 'Y', TO_DATE('2024-08-01', 'YYYY-MM-DD'), 'Y', '계좌이체', TO_DATE('2024-07-22', 'YYYY-MM-DD'), 'C');

-- 5. (기한초과) '2024년 2분기 구글 광고 대행' 계약에 대한 청구
INSERT INTO TBL_INVOICE (INVOICE_NO, CONTRACT_NO, MEMBER_NO, INVOICE_DEPOSIT, INVOICE_SEND, INVOICE_IS_SEND, INVOICE_PAID, INVOICE_IS_PAID, INVOICE_METHOD, REG_DATE, INVOICE_STATUS_CODE)
VALUES ('INV_'||LPAD(SEQ_TBL_INVOICE_NO.NEXTVAL, 4, '0'), 'CNO_0019', 'MEM_001', 12000000, TO_DATE('2024-07-01', 'YYYY-MM-DD'), 'Y', NULL, 'N', '계좌이체', TO_DATE('2024-06-28', 'YYYY-MM-DD'), 'O');
